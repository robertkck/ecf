...
We build on the fact that countries fnd it easier to innovate in technologies that are
...
appear as part of the same patent. We then analyse which
countries are good at patenting the technologies we identifed as being ‘nearby’ our four
low-carbon technologies.

## Technological proximity {-}
<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plot.ly/~gzachmann/31.embed"></iframe>

The heatmap shows the strength of the relationship between two technologies. The connection between two technologies is high if there are many patents classified to belong to both. High relative co-occurence on a patent leads to strong relatedness in red. Blue shows technology classes that are not related. The heatmap illustrates that IPC codes are more likely to concur with
IPC codes that are classifed close to them (ie that share the same frst two digits), as the areas
...
or regulation of electric motors’. We fnd that the potential RTA of Slovakia for wind turbines is
...
In general we fnd that countries that specialise in nearby technologies are already also
